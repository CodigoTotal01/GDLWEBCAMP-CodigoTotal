  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="lista-categorias.php"><i class="fa fa-list-alt"></i> Ver todos</a></li>
      ...
      if ($_SESSION["nivel"] == 1) : ?>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="lista_admin.php"><i class="fa fa-list-alt"></i> Ver todos</a></li>
